...
const getNumberPattern = (locale) => {

    return numberPatterns[locale] || (() => {
        ...
        return (numberPatterns[locale] = { group, seperator });
    })();
};

const parse = (string, locale = 'en-US') => {
    if (string === '') { return null; }
    const { group, seperator } = getNumberPattern(locale);
